...
export default function App() {
  ...
  const [recordedTasks, setRecordedTasks] = useState([]);
    ...
    }, [selectedSession, replayState.duration, recordedTasks, slots, clearStreamBuffers]);
    ...
    // Helper to recursively remap task references in input connections
    const remapTaskReference = (savedObj, templateSlots, loadedSlots) => {
